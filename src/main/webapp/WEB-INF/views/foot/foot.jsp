                                    	...
                                    	<div class="col-sm-12 padding-leftright-null">
                                   			<div class="filter-wrap left">
                                       			<ul class="col-md-12 filters uppercase padding-leftright-null">
                                       				<li data-filter=".liverpool"><a href="board">리버풀</a></li>
                                           			<li data-filter=".footsoccer"  class="is-checked"><a href="foot">풋살</a></li>
		                                           	<li data-filter=".freeboard"><a href="freeboard">자유</a></li>
		                                           	<li data-filter=".humor"><a href="humor">유머</a></li>
		                                           	<li data-filter=".game"><a href="game">게임</a></li>
		                                           	<li data-filter=".animal"><a href="animal">동물</a></li>
		                                           	<li data-filter=".food"><a href="food">음식</a></li>
                                       			</ul>
                                   			</div>
                                   		</div>
                                   </div>
