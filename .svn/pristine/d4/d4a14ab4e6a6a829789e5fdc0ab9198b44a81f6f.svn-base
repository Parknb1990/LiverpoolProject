                                ...
                                <div class="col-sm-12 padding-leftright-null">
                                    <div class="filter-wrap left">
                                        <ul class="col-md-12 filters uppercase padding-leftright-null">
                                            <li data-filter=".Pl" class="is-checked">PL</li>
                            ...
                            <div class="projects-items equal four-columns" align="center">
                                ...
                                <div class="single-item one-item Pl">
                                    <div class="item temp">
                                       ...
                                       <!--  <a href="board" class="link"></a> -->
                                    </div>
                                </div>
                                
                                <div class="single-item one-item Pl">
                                    <div class="item temp">
                                        <img src="/assets/img/Pl/mci.jpg" alt="">
                                        <div class="content">
                                            <h3>Man City</h3>
                                        </div>
                                    </div>
                                ...
                                <div class="single-item one-item Pl">
                                    <div class="item temp">
                                        <img src="/assets/img/Pl/mun.jpg" alt="">
                                        <div class="content">
                                            <h3>Man Utd</h3>
                                        </div>
                                    </div>
                                ...
                                <div class="single-item one-item Pl">
                                    <div class="item temp" >
                                        <img src="/assets/img/Pl/lei.jpg" alt="">
                                        <div class="content">
                                            <h3>Leicester</h3>
                                        </div>
                                    </div>
                                ...
                                <div class="single-item one-item Pl">
                                    <div class="item temp">
                                        <img src="/assets/img/Pl/new.jpg" alt="">
                                        <div class="content">
                                            <h3>Newcastle</h3>
                                        </div>
                                    </div>
                                ...
                                <div class="single-item one-item Pl">
                                    <div class="item temp">
                                        <img src="/assets/img/Pl/bou.jpg" alt="">
                                        <div class="content">
                                            <h3>Bournemouth</h3>
                                        </div>
                                    </div>
